...
int main()
{
    ...
    cout << endl << "c7 (2,1) after *= c3 (3,4):" << endl;
    ...
    cout << endl << "c8 (10,5) after /= c2 (5):" << endl;
    c8.printOn(cout) << endl;

    // Test comparisons
    cout << endl << "c2 < c3: " << (c2 < c3);   // 5 < 3? false
    cout << endl << "c3 > c2: " << (c3 > c2);   // true
    cout << endl << "c1 <= c3: " << (c1 <= c3); // 3+4i <= 3+4i true
    cout << endl << "c3 >= c2: " << (c3 >= c2); // true
    cout << endl << "c1 == c1: " << (c1 == c1); // true
    cout << endl << "c1 != c3: " << (c1 != c3) << endl; // true

    // Test getters
    cout << endl << "c3.getRe(): " << c3.getRe();
    cout << endl << "c3.getIm(): " << c3.getIm() << endl;

    // Test setters
    c1.setRe(10);
    c1.setIm(20);
    cout << endl << "c1 after setRe(10), setIm(20):";
    c1.printOn(cout) << endl;
